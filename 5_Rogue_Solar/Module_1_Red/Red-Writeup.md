...
```text
Starting Nmap 7.95 ( https://nmap.org ) at 2026-06-19 16:34 IST
...
**Expected Output:**
```text
grid/solar/site7/kw 40.23
grid/solar/site7/kw 40.40
grid/solar/site7/kw 40.57
```
...
```bash
mosquitto_pub -h 127.0.0.1 -p 1883 -t "grid/solar/site7/kw" -m "45.00"
```
...
To confirm that the telemetry data was successfully injected and processed by the dashboard, retrieve the web dashboard content:
```bash
curl -s http://127.0.0.1:5000/ | grep -A 2 -B 2 "value"
```
